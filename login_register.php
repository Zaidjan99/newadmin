...
if(isset($_POST['login']))
{
    ...
    if($result)
    {
        if(mysqli_num_rows($result) == 1)
        {
            ...
            {
                $_SESSION['logged_in'] = true; // Add semicolon here
        ...
        else
        {
            echo "
            <script>
                alert('Email_Username Not Registered');
                window.location.href='login.php';
            </script>";
        }
    }
...
if(isset($_POST['register']))
{
    ...
    if($result)
    {
        ...
        else #it will be executed if no one has taken username or email before
        {
            ...
            $query = "INSERT INTO `register`(`fullname`, `username`, `email`, `password`) VALUES ('$_POST[fullname]','$_POST[username]','$_POST[email]','$password')";
